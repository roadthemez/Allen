...
<div class="main-container">
	<div class="page-content">
		<div class="container">
			...
			<?php if($shoplayout=='fullwidth'){ ?>
				<div id="secondary" class="shop-sidebar-filter row">
					...
					<div id="archive-product" class="col-xs-12 <?php echo 'col-md-'.$shopcolclass; ?>">
						...
						<div class="archive-border">
							...
							<?php if ( have_posts() ) : ?>
								...
								<div class="toolbar">
									<div class="view-mode">
										<label><?php esc_html_e('View on', 'allen');?></label>
										<a href="#" class="grid <?php if($road_viewmode=='grid-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'Grid', 'allen' ); ?>"><i class="fa fa-th"></i></a>
										<a href="#" class="list <?php if($road_viewmode=='list-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'List', 'allen' ); ?>"><i class="fa fa-th-list"></i></a>
									</div>
									<?php
										/**
		...
		<div class="inner-brands">
			<div class="container">
				<h3 class="widget-title"><span><?php echo esc_html( $road_opt['brand_title'] ); ?></span></h3>

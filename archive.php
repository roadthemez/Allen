					...
					<?php if ( have_posts() ) : ?>
						<header class="archive-header">
							<h1 class="archive-title"><?php
								if ( is_day() ) :
									printf( esc_html__( 'Daily Archives: %s', 'allen' ), '<span>' . get_the_date() . '</span>' );
								elseif ( is_month() ) :
									printf( esc_html__( 'Monthly Archives: %s', 'allen' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'allen' ) ) . '</span>' );
								elseif ( is_year() ) :
									printf( esc_html__( 'Yearly Archives: %s', 'allen' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'allen' ) ) . '</span>' );
								else :
									esc_html_e( 'Archives', 'allen' );
								endif;
							?></h1>
